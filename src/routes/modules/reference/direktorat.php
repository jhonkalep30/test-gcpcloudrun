...
use App\Http\Controllers\Reference\ClassifierController;
use App\Http\Controllers\Reference\DirektoratController;
...
Route::group([
    'prefix' => 'reference/direktorat',
    'controller' => DirektoratController::class,
    'acl_group' => 'Direktorat',
    'as' => 'direktorat.'
], function(){
